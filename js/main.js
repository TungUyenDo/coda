...
function setTrafficChart() {
  var data = [
    { data: [65, 59, 80, 81, 56, 55, 40], label: "Direct", color: "#FF8534" },
    { data: [28, 48, 40, 19, 86, 27, 90], label: "Referral", color: "#64b5f6" }
  ];
...
function setDevelopmentChart() {
  var data = [{ data: [65, 59, 80, 81, 56, 55, 40], label: "Direct" }, { data: [28, 48, 40, 19, 86, 27, 90], label: "Referral" }];
  ...
  if (morrrisChart) {
    ...
    Morris.Donut({
      ...
      data: [
        ...
        { label: "Income", value: 15 },
        { label: "Capital", value: 45 },
...
function initEcharts() {
  ...
  if (areaChartContainer) {
    var area = echarts.init(areaChartContainer, { width: "100%" }),
    ...
    series: [
      {
        ...
        radius: "90%",
        center: ["50%", "50%"],
        data: [{ value: 335 }, { value: 310 }, { value: 274 }, { value: 235 }, { value: 400 }].sort(function(a, b) {
...
function setBarsChart(ctx) {
  var data = [{ data: [65, 59, 80, 81, 56, 55, 40], label: "Series A" }, { data: [28, 48, 40, 19, 86, 27, 90], label: "Series B" }];
...
function setRadarChart(ctx) {
  var data = [{ data: [65, 59, 90, 81, 56, 55, 40], label: "Series A" }, { data: [28, 48, 40, 19, 96, 27, 100], label: "Series B" }];
